...
<head>
	<meta charset="UTF-8">
	<title>Thank you for creating an account for Learn Baybayin...</title>
	<style>
		body, html {
			margin: 0px;
...
<body>
	...
	<div style="height:95px;width:100%;background-color:#ffc107;text-align:center;font-size:42px;font-weight:bold;padding-top:40px;">
		Learn Baybayin App
	</div>

	<table style="width:65%;background-color:#fff9e6;padding:5px;" align="center">
		<tr>
			<td>
	...
	<br />
	<center style="color:#bfbfbf;font-size:12px;">
		<a style="color:#bfbfbf;font-size:12px;" target="_blank" href="http://learnbaybayinapp.iamcebu.com/tos.html">Terms and Conditions</a> | <a style="color:#bfbfbf;font-size:12px;" target="_blank" href="https://www.instagram.com/thejamesarnold/">Instagram</a>
	</center>
